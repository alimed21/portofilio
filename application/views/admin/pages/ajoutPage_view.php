            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Formulaire des pages</h4>
                    </div>
                    <div class="card-content">
                        ...
                        <?php if($this->session->flashdata('error')):?>
							...
							<?php endif;?>
                        <div class="card-body">
                            <form class="form" action="<?php echo base_url();?>Admin/Pages/verificationAjout" method="post" enctype="multipart/form-data">
                                <div class="row">
