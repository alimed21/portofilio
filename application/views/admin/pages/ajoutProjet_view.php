                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <?php if($this->session->flashdata('error')):?>
							...
							<?php endif;?>
                        <div class="card-body">
                            <form class="form" action="<?php echo base_url();?>Admin/Projets/verificationAjout" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="etat" id="etat" class="form-control">
                                                <option selected>Etat d'avancement du projet</option>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lien" name="lien" class="form-control" placeholder="Saisissez le lien du projet">
                                            <span class="messageErreur">
